...
class Pattern:
    ...
    def get_complexity(self):
        return sum(blk.get_complexity() for blk in self.blocks)

    def get_param_count(self):
        return sum(blk.get_param_count() for blk in self.blocks)

    def get_generalizability_index(self):
        return sum(blk.get_generalizability_index() for blk in self.blocks)
